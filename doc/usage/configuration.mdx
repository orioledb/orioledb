...
Size of OrioleDB in-memory rewind buffers. Each MB can acommodate around 15000 rewind transaction items. If you have
enough memory set it near a value (`orioledb.rewind_max_transactions` / 15000) MB to avoid writing rewind info to disk.

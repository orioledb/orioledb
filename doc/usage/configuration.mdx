...
Number of orioledb in-memory rewind buffers in blocks. Each block can ccommodate 68 rewind transaction items. If you have enough memory set it near a value `orioledb.rewind_max_transactions` / 68 to avoid writing rewind info to disk.

...
```
psql (17.7 OrioleDB public beta 15 PGTAG=patches17_18 alpine:3.21+clang build:2025-10-25T19:54:25+00:00 17.7)
Type "help" for help.
postgres=#
```
...
- `--build-arg PG_LLVM_ENABLED="false"`
  - Disable PostgreSQL LLVM/JIT support when the distro LLVM is too new for the selected PostgreSQL/OrioleDB combination.

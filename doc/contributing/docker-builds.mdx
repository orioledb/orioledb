...
```
psql (17.5 OrioleDB public beta 12 PGTAG=patches17_9 alpine:3.21+clang build:2024-10-25T19:54:25+00:00 17.5)
Type "help" for help.
postgres=#
```
...
-------------------------------------------------------------------------
 ...
 function orioledb_table_size(oid)
 ...
 function orioledb_total_relation_size(oid)

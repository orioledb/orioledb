...
#define ORIOLE_WAL_RECORDS(X) \
	...
	X(WAL_REC_CIC_PHASE_3_START,    20, "CIC_PHASE_3_START",  wal_parse_rec_cic_phase) \
	X(WAL_REC_CIC_PHASE_4,          21, "CIC_PHASE_4",        wal_parse_rec_cic_phase) \
	X(WAL_REC_CIC_PHASE_FLIP,       22, "CIC_PHASE_FLIP",     wal_parse_rec_cic_phase)

...
extern BTreeChunkDesc *make_chunk_desc(BTreeDescr *treeDesc,
									   const BTreeChunkOps *ops,
									   Page page, OffsetNumber chunkOffset);
extern void release_chunk_desc(BTreeChunkDesc *desc);
...
extern int	page_get_hikey_size(BTreePageContext *pageContext);

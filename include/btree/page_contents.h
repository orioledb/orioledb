...
extern bool o_btree_read_page(BTreePageContext *destPageContext, OInMemoryBlkno blkno,
...
extern ReadPageResult o_btree_try_read_page(BTreePageContext *destPageContext,
											...
											CommitSeqNo *readCsn);
extern UndoLocation read_page_from_undo(BTreePageContext *destPageContext,
...
extern int	page_get_hikey_size_old(Page p);

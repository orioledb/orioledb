...
static inline void
read_tuple_chunk_leaf_item(BTreeChunkDesc *desc, Page page, OffsetNumber itemOffset,
...
static inline void
read_tuple_chunk_internal_item(BTreeChunkDesc *desc, Page page,
							   OffsetNumber itemOffset,
...
read_tuple_chunk_tuple(BTreeChunkDesc *desc, Page page, OffsetNumber itemOffset)
{
	Pointer		item = get_tuple_chunk_item(desc, itemOffset);
	OTuple		result;

...
_PG_init(void)
{
	...
	/*
	 * When PostgreSQL decides that recovery has stopped at a requested
	 * target, Oriole must still align its own replay/finalization state with
	 * that stop boundary before pause/promote/shutdown becomes externally
	 * visible.
	 */

...
bankcrashcheck: $(INSTALL_REQUIREMENT)
	RR_WRITERS='$(RR_WRITERS)' RR_ACCOUNTS='$(RR_ACCOUNTS)' \
	RR_DURATION='$(RR_DURATION)' RR_ROLLBACKERS='$(RR_ROLLBACKERS)' \
	RR_ERROR_INJECTIONS='$(RR_ERROR_INJECTIONS)' RR_ASSERT_INJECTIONS='$(RR_ASSERT_INJECTIONS)' \
	RR_ASSERT_PERIOD='$(RR_ASSERT_PERIOD)' RR_REPLICAS='$(RR_REPLICAS)' \
	RR_KILL_POSTMASTER='$(RR_KILL_POSTMASTER)' RR_KILL_POSTMASTER_INTERVAL='$(RR_KILL_POSTMASTER_INTERVAL)' \
	RR_PANIC_FATAL='$(RR_PANIC_FATAL)' RR_SAVE_ALL_LOGS='$(RR_SAVE_ALL_LOGS)' \
	TIMEOUT='$(TIMEOUT)' VENV_ACTIVATE='$(VENV_ACTIVATE)' \
	test/t/crash/run_hunt.sh

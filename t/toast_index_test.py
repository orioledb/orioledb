	...
	def do_update(self, con, j):
		for i in range(0, 10):
			...
			con.execute(
			    ...
			    % (gen_str(2500, baseIndex), gen_str(
			        2500, baseIndex + 1), gen_str(2500, baseIndex + 2), i + 1))

...
class RecoveryUnusualTypesTest(BaseTest):
	...
	def test_nested_composite_pk(self):
		self._crash_and_recover(
			...
			""", "SELECT v FROM o_test ORDER BY k;", [(10, ), (20, )])
	...
	def test_multirange_pk(self):
		self._crash_and_recover(
			...
			""", "SELECT v FROM o_test ORDER BY r;", [(1, ), (2, )])
	...
	def test_composite_with_range_attr_pk(self):
		self._crash_and_recover(
			...
			""", "SELECT v FROM o_test ORDER BY k;", [(1, ), (2, )])
	...
	def test_composite_array_index(self):
		self._crash_and_recover(
			...
			""", "SELECT id FROM o_test ORDER BY id;", [(1, ), (2, )])
	...
	def test_domain_cast_in_expr_index(self):
		self._crash_and_recover(
			...
			""", "SELECT id FROM o_test WHERE (val::dpos) = 7 ORDER BY id;", [(7, )])
...
class RecoveryUnusualExprTest(BaseTest):
	...
	def test_subscript_expr_index(self):
		self._crash_and_recover(
			...
			""", "SELECT id FROM o_test WHERE arr[1] = 5 ORDER BY id;", [(5, )])
	...
	def test_array_coerce_expr_index(self):
		self._crash_and_recover(
			...
			""", "SELECT id FROM o_test ORDER BY id LIMIT 1;", [(1, )])
	...
	def test_coerce_via_io_expr_index(self):
		self._crash_and_recover(
			...
			""", "SELECT id FROM o_test WHERE s::int = 5 ORDER BY id;", [(5, )])
...
class RecoveryUnusualCustomTypeTest(BaseTest):
	...
	def test_composite_with_dropped_col_pk(self):
		self._crash_and_recover(
			...
			""", "SELECT v FROM o_test ORDER BY v;", [(10, ), (20, )])
	...
	def test_enum_pk(self):
		self._crash_and_recover(
			...
			""", "SELECT v FROM o_test ORDER BY m;", [(1, ), (3, ), (2, )])

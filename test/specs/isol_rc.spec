...
permutation "s2_setup" "s3_setup" "s1_se_set" "s1_begin" "s1_update_toast" "s2_update_toast" "s3_update_toast" "s1_commit" "s1_se_set2" "s1_reset"(s2_update_toast)
permutation "s2_setup" "s3_setup" "s1_se_set" "s1_begin" "s1_update_toast2" "s2_update_toast2" "s3_update_toast2" "s1_commit" "s1_se_set2" "s1_reset"(s2_update_toast2)
